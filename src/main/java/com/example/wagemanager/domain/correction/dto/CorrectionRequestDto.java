    ...
    public static class Response {
        ...
        public static Response from(CorrectionRequest request) {
            ResponseBuilder builder = Response.builder()
                    ...
                    .originalWorkDate(request.getWorkRecord().getWorkDate())
                    .originalStartTime(request.getWorkRecord().getStartTime())
                    .originalEndTime(request.getWorkRecord().getEndTime())
